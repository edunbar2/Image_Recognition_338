...
# personal path on computer, needs updated on download.
model = load_model("C:\\Users\\john_doe\\file_path\\Saved_model.h5")
...
# find image in file system and prepare for use
def upload_image():
...
# project classify image button after image has been uploaded
...
# run image through model and predict animal
